...
const specialDishes = [
  ...
  { id: "kerala_chapati", name: "Chappathi", name_ml: "ചപ്പാത്തി", category: "Kerala Breakfast Foods", food_type: "cooked", unit: "g", nutrition_per_100g: { calories_kcal: 260, protein_g: 8.5, carbs_g: 48.0, fat_g: 3.2, fiber_g: 5.5, sugar_g: 0.5, saturated_fat_g: 0.8, sodium_mg: 290 }, calculation: { minimum_quantity_g: 10, maximum_quantity_g: 1000, quantity_step_g: 1 }, search_keywords: ["chapati", "chappathi", "chappati", "roti", "phulka", "ചപ്പാത്തി"] },
  ...
  // Generic non-veg favorites to catch simple searches
  { id: "kerala_chicken_fry_generic", name: "Chicken Fry", name_ml: "ചിക്കൻ ഫ്രൈ", category: "Chicken Dishes", food_type: "fried", unit: "g", nutrition_per_100g: { calories_kcal: 250, protein_g: 20.0, carbs_g: 3.0, fat_g: 18.0, fiber_g: 0.2, sugar_g: 0.1, saturated_fat_g: 4.2, sodium_mg: 380 }, calculation: { minimum_quantity_g: 10, maximum_quantity_g: 1000, quantity_step_g: 1 }, search_keywords: ["chicken fry", "kozhi porichathu", "chiken fry", "fried chicken", "chicken lollipop", "lollipop", "lolipop", "lolipo", "ചിക്കൻ ഫ്രൈ"] },
  { id: "kerala_chicken_curry_generic", name: "Chicken Curry", name_ml: "ചിക്കൻ കറി", category: "Chicken Dishes", food_type: "curry", unit: "g", nutrition_per_100g: { calories_kcal: 160, protein_g: 18.0, carbs_g: 4.0, fat_g: 8.0, fiber_g: 0.5, sugar_g: 0.8, saturated_fat_g: 2.2, sodium_mg: 310 }, calculation: { minimum_quantity_g: 10, maximum_quantity_g: 1000, quantity_step_g: 1 }, search_keywords: ["chicken curry", "kozhi curry", "chiken curry", "ചിക്കൻ കറി"] },
  { id: "kerala_beef_fry_generic", name: "Beef Fry", name_ml: "ബീഫ് ഫ്രൈ", category: "Beef Dishes", food_type: "fried", unit: "g", nutrition_per_100g: { calories_kcal: 260, protein_g: 22.0, carbs_g: 2.0, fat_g: 18.0, fiber_g: 0.5, sugar_g: 0.2, saturated_fat_g: 5.5, sodium_mg: 420 }, calculation: { minimum_quantity_g: 10, maximum_quantity_g: 1000, quantity_step_g: 1 }, search_keywords: ["beef fry", "beef ularthiyathu", "erachi fry", "ബീഫ് ഫ്രൈ", "ബീഫ് ഉലർത്തിയത്"] },
  { id: "kerala_beef_curry_generic", name: "Beef Curry", name_ml: "ബീഫ് കറി", category: "Beef Dishes", food_type: "curry", unit: "g", nutrition_per_100g: { calories_kcal: 190, protein_g: 20.0, carbs_g: 4.0, fat_g: 11.0, fiber_g: 0.8, sugar_g: 0.5, saturated_fat_g: 3.5, sodium_mg: 340 }, calculation: { minimum_quantity_g: 10, maximum_quantity_g: 1000, quantity_step_g: 1 }, search_keywords: ["beef curry", "erachi curry", "ബീഫ് കറി"] },
  { id: "kerala_fish_fry_generic", name: "Fish Fry", name_ml: "മീൻ വറുത്തത്", category: "Fish & Seafood", food_type: "fried", unit: "g", nutrition_per_100g: { calories_kcal: 210, protein_g: 19.0, carbs_g: 2.0, fat_g: 14.0, fiber_g: 0.2, sugar_g: 0.0, saturated_fat_g: 2.8, sodium_mg: 390 }, calculation: { minimum_quantity_g: 10, maximum_quantity_g: 1000, quantity_step_g: 1 }, search_keywords: ["fish fry", "meen varuthathu", "fried fish", "മീൻ വറുത്തത്"] },
  { id: "kerala_fish_curry_generic", name: "Fish Curry", name_ml: "മീൻ കറി", category: "Fish & Seafood", food_type: "curry", unit: "g", nutrition_per_100g: { calories_kcal: 130, protein_g: 16.0, carbs_g: 3.0, fat_g: 6.0, fiber_g: 0.4, sugar_g: 0.2, saturated_fat_g: 1.8, sodium_mg: 290 }, calculation: { minimum_quantity_g: 10, maximum_quantity_g: 1000, quantity_step_g: 1 }, search_keywords: ["fish curry", "meen curry", "kerala fish curry", "മീൻ കറി"] }
];

// Helper programmatically compiled foods
const generatedFoods: any[] = [];
...
// Run base configuration transformations
baseFoods.forEach(food => {
  const types = Object.keys(food.variations) as Array<keyof typeof food.variations>;
...
// Pad database to over 500+ items using combinations of proteins, grains, and fruits & vegetables
const supplementaryGrains = ["Rice Matta", "Rice Basmati", "Rice Ponni", "Rice Jasmine", "Rice Sona Masuri", "Wheat Atta", "Semolina Rava", "Ragi Millet", "Oats Rolled", "Barley Grain", "Corn Maize", "Quinoa Grain"];
const prepMethods = [
...
supplementaryProteins.forEach(prot => {
  prepMethods.forEach(prep => {
    ...
    const foodItem = {
      ...
      search_keywords: [prot.name.toLowerCase(), prep.eng.toLowerCase(), prot.name_ml.toLowerCase(), prep.ml]
    };
...
supplementaryGrains.forEach((grain, grainIdx) => {
  prepMethods.slice(0, 4).forEach((prep) => {
    ...
    const foodItem = {
      ...
      unit: "g",
      nutrition_per_100g: {
        calories_kcal: Math.round((baseCal * 0.35) * scale),
